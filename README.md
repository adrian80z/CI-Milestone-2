...
#### Structure of gameboard.html page: 
...
1. Click on Play Game button. Four buttons shows on screen (Easy, Medium, Hard and Main Menu). Current two are hide (Play Game, How To Play).
 - Click on Easy button moves to gameboard.html page.
 - Click on Medium button moves to gameboard. html page.
 - Click on Hard button moves to gameboard.html page.
 - Click to Main Menu button. Current four buttons are hide and previous two menu button are shown.
2. Click on How to Play button - modal window appears on screen
 - Click X letter on top right corner to close modal
 - Click any were outside modal close it.
...
4. Win/Game Over menu buttons:
 - Click Play Again. Reload page and game starts.
 - Click Main Menu moves to index.html page.
